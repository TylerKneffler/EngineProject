...
- [ ] MEDIUM: Add backend GPU timestamp telemetry for terrain, portal, opaque, transparent, and presentation work. Report CPU submission separately from GPU execution and investigate DX11 flip-model swap chains to reduce the observed presentation spikes.
