...
// ---------------------------------------------------------------------------
// VulkanGameRenderer — Vulkan implementation of IGameRenderer
//
// Manages the game rendering pipeline using Vulkan.
// Provides window rendering with double-buffering and frame synchronization.
// ---------------------------------------------------------------------------
class VulkanGameRenderer : public IGameRenderer
{
public:
    VulkanGameRenderer() = default;
    virtual ~VulkanGameRenderer();
