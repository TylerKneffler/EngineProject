...
public:
    ...
    bool BeginChild(const char*) override; void EndChild() override; bool IsItemHovered()const override; bool IsItemClicked()const override;
...
private:
    ...
    bool m_drawingDragPreview=false;
